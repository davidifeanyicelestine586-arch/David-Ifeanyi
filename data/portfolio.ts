...
export const projects: Project[] = [
  {
    ...
    status: "Flagship",
    description: "A deterministic architecture workspace for defining a project, analyzing requirements, recommending compatible technologies, validating decisions and generating an implementation blueprint.",
    ...
    live: "https://architect.ediccrew.com",
    caseStudy: "/projects/tech-stack-architect",
  },
  {
    name: "Sharp AI",
    status: "MVP",
  ...
  },
  {
    name: "StoryPix",
    status: "Early-stage",
    description: "An AI-oriented creative application whose current feature set requires continued source-level verification beyond the inherited repository README.",
  ...
  },
  {
    ...
    description: "An Android project in the portfolio. Its repository has a documented security-hygiene concern, so sensitive artifacts are deliberately excluded from portfolio content.",
  ...
  },
  {
    ...
    repository: "https://github.com/davidifeanyicelestine586-arch",
    live: "https://ediccrew.com",
  },
  {
    name: "VizualMecha Studio",
    status: "Early-stage",
    description: "An early-stage project exploring virtual mechatronics and 3D visualization concepts. The broader concept is kept distinct from limited repository implementation.",
    stack: ["Mechatronics", "3D visualization"],
    repository: "https://github.com/davidifeanyicelestine586-arch/VizualMecha-Studio-",
  },
  {
