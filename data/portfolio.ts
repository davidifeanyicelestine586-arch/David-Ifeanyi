export type ProjectStatus = "Featured" | "MVP" | "Early-stage" | "Prototype" | "Active" | "Archived";
...
export const projects: Project[] = [
  { name: "Tech Stack Architect", status: "Featured", description: "A workspace for turning project requirements into technology recommendations, validation steps and an implementation blueprint.", stack: ["Next.js", "React", "TypeScript", "Tailwind CSS", "shadcn/ui", "Supabase"], repository: "https://github.com/davidifeanyicelestine586-arch/tech-stack-architect", live: "https://architect.ediccrew.com", caseStudy: "/projects/tech-stack-architect" },
  { name: "Sharp AI", status: "MVP", description: "An AI-assisted content studio for turning one idea into blog, social and email formats. Production persistence, authentication and billing remain incomplete.", stack: ["Next.js", "React", "TypeScript", "Express", "OpenAI"], repository: "https://github.com/davidifeanyicelestine586-arch/sharp-ai" },
  { name: "StoryPix", status: "Early-stage", description: "An AI-oriented creative application whose current feature set still needs source-level verification beyond the inherited repository README.", stack: ["React", "Vite", "TypeScript", "Express"], repository: "https://github.com/davidifeanyicelestine586-arch/StoryPix" },
  { name: "Ediccrew Workflow", status: "Early-stage", description: "An Android project in the portfolio. Its repository has a documented security-hygiene concern, so sensitive artifacts are deliberately excluded from portfolio content.", stack: ["Android", "Gradle"], repository: "https://github.com/davidifeanyicelestine586-arch/Ediccrew-workflow" },
  { name: "Ediccrew.com", status: "Active", description: "A technology-focused WordPress publication and web project covering technology, people, trends, tools and practical build-oriented topics.", stack: ["WordPress", "Elementor", "SEO", "Web tooling"], live: "https://ediccrew.com" },
  { name: "VizualMecha Studio", status: "Early-stage", description: "An early-stage project exploring virtual mechatronics and 3D visualization concepts. The broader concept is kept distinct from the limited repository implementation.", stack: ["Mechatronics", "3D visualization"], repository: "https://github.com/davidifeanyicelestine586-arch/VizualMecha-Studio-" },
  ...
  { name: "My First Line of Code", status: "Archived", description: "A simple first web programming project preserved as an early marker in the progression toward larger systems.", stack: ["HTML", "CSS", "JavaScript"], repository: "https://github.com/davidifeanyicelestine586-arch/my-first-line-of-code" },
];
